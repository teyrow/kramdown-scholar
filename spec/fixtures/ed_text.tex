...
simple \edtext{the \emph{bold text}}{\footnote{footnote \textbf{with} space}}

simple \edtext{more
text}{\footnote{second footer}}

simple \edtext{the \emph{bold text}}{\footnoteA{footnote \textbf{with} space}}

simple \edtext{the \emph{bold text}}{\Bfootnote{footnote-b \textbf{with} space}}
